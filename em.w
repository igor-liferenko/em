...
$$\hbox to14.25cm{\vbox to2.75cm{\vfil\special{
  psfile=buffer-gap.eps clip llx=0 lly=-1 urx=404 ury=77 rwi=4040}}\hfil}$$
...
@ Control sequences beginning with escape character (code |0x1b|) are generated by terminal
