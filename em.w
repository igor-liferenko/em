...
@ We use finite state automata to scan control sequences generated by pressing on certain buttons.
This is the identity between control code
sequences and keyboard buttons by which they are generated:
\medskip
{\tt\obeylines\obeyspaces
|@t\hskip1.6em@> 0x1B 0x5B 0x41 == Up|
|@t\hskip1.6em@> 0x1B 0x5B 0x42 == Down|
|@t\hskip1.6em@> 0x1B 0x5B 0x44 == Left|
|@t\hskip1.6em@> 0x1B 0x5B 0x43 == Right|
|@t\hskip1.6em@> 0x1B 0x5B 0x46 == End|
|@t\hskip1.6em@> 0x1B 0x5B 0x48 == Home|
...
@<Scan control sequences@>=
        case
                L'\x1b':
                if (scanning) scanning=0; /* invalid */
		else scanning=1; /* start scanning */
                break;
        case
                L'\x5b':
...
@^TODO@>
	...
	int scanning=0; /* used in |@<Scan cont...@>| */
	while (!done) {
		display();
